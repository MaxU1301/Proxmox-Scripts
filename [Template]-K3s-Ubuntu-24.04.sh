...
virt-customize -a "$file" --install net-tools
...
# Create VM Template
qm create "$vmid" --name "ubuntu-2404-k3s-template" --memory 4096 --cores 2 --net0 virtio,bridge=vmbr0
...
# Resize Template Disk to 30 GiB total
qm resize "$vmid" scsi0 +26.5G
